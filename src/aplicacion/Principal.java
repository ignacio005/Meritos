...
//segundo, el índice de impacto.
        ...
        Articulo articulo2 = new Articulo("Lo nunca visto",
                2.765);
        Articulo articulo3 = new Articulo("Pasen y vean",
                1.987);
        Articulo articulo4 = new Articulo("El no va más del " +
                "qué se yo", 2.134);
//El primer parámetro del constructor es el título y, el
//segundo, la financiación con la que ha contado el
//proyecto.
        Proyecto proyecto1 = new Proyecto("El puente de " +
                "Villar del Río",1000000);
        Proyecto proyecto2 = new Proyecto("El acueducto de " +
                "Villar del Campo",
                2000000);
        Proyecto proyecto3 = new Proyecto("El sistema de " +
                "información de " +
                "Villar del Río",
                1200000);
        ProfesorTitular pt1 = new ProfesorTitular("Pepe");
...
//como del catedrático
        System.out.println("La valoración de profesor titular "
                + "pt1 es " +
                pt1.calcularValoracion());
